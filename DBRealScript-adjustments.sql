...
clearance_status ENUM('paid', 'pending', 'refunded') NOT NULL,
trainee_id INT NOT NULL,
...
VALUES
	('french_cuisine', '2023-10-02', '2023-12-17', 90000.00, 'EU1046', 30),
    ('japanese_cuisine', '2023-10-03', '2023-12-17', 85000.00, 'AS204', 15),
    ('greek_cuisine', '2023-10-02', '2023-12-17', 63000.00, 'AS304', 35),
    ('filipino_cuisine', '2023-10-03', '2023-12-17', 78000.00, 'AS602', 40),
    ('italian_cuisine', '2023-10-04', '2023-12-17', 83000.00, 'EU407', 25);

-- attendance
INSERT INTO attendance (attendance_report_id, attendance_date, mentor_id, present_mentor, training_program)
VALUES
	(2301,'2023-10-24', 99902, 1, 'japanese_cuisine'),
    (2302,'2023-10-24', 99904, 1, 'filipino_cuisine'),
    (2303,'2023-10-23', 99903, 1, 'greek_cuisine'),
    (2304,'2023-10-23', 99901, 1, 'french_cuisine'),
    (2305,'2023-10-25', 99905, 1, 'italian_cuisine');
...
VALUES
	(123556, 219812, 'japanese_cuisine', '2023-09-03'),
    (167899, 223692, 'filipino_cuisine', '2023-08-27'),
    (215644, 227279, 'greek_cuisine', '2023-08-15'),
    (242565, 231967, 'french_cuisine', '2023-09-05'),
    (389072, 234678, 'italian_cuisine', '2023-09-06');

-- trainee_assessment
INSERT INTO trainee_assessment (assessment_id, evaluation_date, trainee_id, mentor_id, evaluation_score, explanation)
VALUES
	(12,'2023-12-18', 219812, 99902, '2.0', 'Could use more practice with precise knife cuts, there are numerous wasted parts of fish because of imprecise cuts'),
    (252,'2023-12-18', 223692, 99904, '3.5', 'Exemplary in cooking traditional dishes like adobo and sinigang. Makes use of various spices to enhance dish flavors'),
    (702,'2023-12-18', 227279, 99903, '2.5', 'Is able to maximize flavor with minimal ingredients like for shakshuka, thought often adds too much oil to dishes'),
...
VALUES
	(202379257, '2023-09-12', 70000.00),
    (202379375, '2023-09-05', 78000.00),
    (202379678, '2023-09-25', 63000.00),
    (202379767, '2023-09-16', 45000.00),
    (202379844, '2023-09-14', 83000.00);
    
-- clearance_report
INSERT INTO clearance_report (clearance_report_id, clearance_status, trainee_id, program_name, clearance_date, receipt_or_no)
VALUES
	(219812, 'pending', 219812, 'japanese_cuisine', NULL , 202379257),
    (223692, 'paid', 223692, 'filipino_cuisine', '2023-09-05', 202379375),
    (237279, 'paid', 227279, 'greek_cuisine', '2023-09-25', 202379678),
    (241967, 'pending', 231967, 'french_cuisine', NULL ,202379767),
    (254678, 'paid', 234678, 'italian_cuisine',  '2023-09-14', 202379767);
