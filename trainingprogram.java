...
public class trainingprogram 
{
    ...
    public int modifyTrainingProgram(String program_name, java.sql.Date start_date, java.sql.Date end_date, float cost, String venue, int class_limit) 
    {
        try 
        {
            ...
            PreparedStatement pstst = conn.prepareStatement("UPDATE enrollment SET finish_date = ? WHERE training_program = ?");
            ...
            pstst = conn.prepareStatement("UPDATE enrollment SET end_date = ? WHERE program_name = ?");
            pstst.setDate(1, end_date);
            pstst.setString(2, program_name);
    ...
    public static void main (String args[])
    {
        ...
        D.deleteTrainingProgram("french_cuisine");
    }
}
