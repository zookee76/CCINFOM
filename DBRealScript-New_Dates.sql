...
VALUES
	(2301,'2023-04-24', 99902, 1, 'japanese_cuisine'),
    (2302,'2023-07-25', 99904, 1, 'filipino_cuisine'),
    (2303,'2023-02-16', 99903, 1, 'greek_cuisine'),
    (2304,'2023-10-16', 99901, 1, 'french_cuisine'),
    (2305,'2023-11-15', 99905, 1, 'italian_cuisine');
...
VALUES
    ...
    (254678, 'pending', 234678, 'italian_cuisine',  NULL, 202379767);
