<%-- 
    Document   : logattendance_processing
    Created on : 11 20, 23, 12:56:24 AM
    Author     : ccslearner
--%>
    ...
    <body>
        <form action = "index.html">
            ...
            <%  
                ...
                int status = E.logAttendance(E.attendance_date, E.mentor_id, E.present_mentor, E.training_program, E.trainee_ids);
            ...
            <% } else {%>
            <h1>Failed to Log Attendance.</h1>
            <% }%>
