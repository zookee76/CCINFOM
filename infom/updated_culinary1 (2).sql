...
(
program_name VARCHAR(45) PRIMARY KEY NOT NULL,
start_date DATE NOT NULL,
end_date DATE UNIQUE NULL,
cost FLOAT UNIQUE NOT NULL,
...
(
training_program VARCHAR(45) PRIMARY KEY NOT NULL,
...
(
    ...
    CONSTRAINT `fk_trainee_assessment_trainee_id`
        FOREIGN KEY (trainee_id)
        REFERENCES culinary_db.trainee (trainee_id),
    CONSTRAINT `fk_trainee_assessment_training_program`
        FOREIGN KEY (training_program)
        REFERENCES culinary_db.training_program (program_name)
);
...
(
    ...
    PRIMARY KEY (or_no, total_amount),
    CONSTRAINT fk_receipt_total_amount
    FOREIGN KEY (total_amount)
    REFERENCES culinary_db.training_program (cost)
);
--
...
-- enrollment
INSERT INTO enrollment(enrollment_id, trainee_id, training_program, enrollment_date, finish_date)
VALUES
...
-- trainee_assessment
INSERT INTO trainee_assessment (assessment_id, evaluation_date, trainee_id, mentor_id, evaluation_score, explanation, training_program)
VALUES
...
VALUES
    ...
    (241967, 'unpaid', 231967, 'french_cuisine', NULL , NULL),
